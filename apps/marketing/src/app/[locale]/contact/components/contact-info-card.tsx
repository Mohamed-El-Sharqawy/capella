...
export function ContactInfoCard({ contactInfo }: ContactInfoCardProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm p-6 space-y-6">
      ...
      {/* WhatsApp QR Code */}
      <div className="pt-6 border-t">
        <p className="text-sm text-gray-500 mb-3">{t("whatsappContact")}</p>
        <div className="flex flex-col items-center gap-3 bg-gray-50 rounded-xl p-4">
          <div className="bg-white p-3 rounded-lg shadow-sm">
            <img
              src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://wa.me/971524514147"
          ...
          <div className="text-center">
            <p className="text-xs text-gray-500 mb-1">{t("scanToChat")}</p>
            <a
              href="https://wa.me/971524514147"
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm font-medium text-green-600 hover:text-green-700 transition flex items-center justify-center gap-1"
            >
